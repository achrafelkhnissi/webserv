...
int is_newline(Token *t) { return t->type == Token::NEWLINE || t->type == Token::COMMENT ; }
int is_close(Token *t) { return t->type == Token::CLOSEBRACKET || t->type == Token::COMMENT ; }
